...
for delay in range(1,21):
    enc_voc_size = input_dim = delay * 8
    batch_size = 4
    ...
    prediction_rmse = predict_and_evaluate(transformer_model, dataloaders, criterion,input_dim,delay)
    all_predictions.append(prediction_rmse)
